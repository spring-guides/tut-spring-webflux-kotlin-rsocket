...
The `HtmlController` class no longer needs to handle any of the streaming logic. Its purpose is now to serve the static page, so the implementation becomes trivial:
